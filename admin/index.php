...
<html>
    <head>
        <link rel ="stylesheet" type="text/css" href="./lib/css/bootstrap-4.1.0/dist/css/bootstrap.css"/>
        ...
        <script src="./lib/css/bootstrap-4.1.3-dist/js/bootstrap.js"></script>
...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
    ...
    <body class="fond img-fluid">
        <div>
            ...
            <img src="./images/accueil.jpg" class="img-responsive banniere"  alt="banniere">
            <?php
                ...
                <div>
                    <?php
                        if(!isset($_SESSION['pages'])){
                            $_SESSION['pages']="accueil_admin";
                        }
                        if(isset($_GET['pages'])){
                            $_SESSION['pages']=$_GET['pages'];
                        }
                        $path='./pages/'.$_SESSION['pages'].'.php';
